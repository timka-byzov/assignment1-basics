...
def run_linear(
    ...
    linear = StanofordLinear(d_in, d_out, "cpu")
...
def run_embedding(
    ...
    embedding = StanfordEmbedding(vocab_size, d_model)
...
def run_swiglu(
    ...
    swiglu = StanfordSwiGLU(d_model, d_ff)
...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.layers.scaled_dot_product_attention import StanfordAttention

    return StanfordAttention().forward(Q, K, V, mask)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    return StanfordSoftMax().forward(in_features, dim)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    from cs336_basics.bpe.main import BPE

    bpe = BPE()
    byte_dict, merges = bpe.fit(
        str(input_path),
        special_tokens,
        vocab_size,
    )
